...
| ADR | Decisão | Status |
| --- | --- | --- |
| [0001](0001-decoradores-ecmascript-stage-3.md) | Usar decoradores ECMAScript Stage 3 | Accepted |
...
| [0008](0008-chaves-primarias-tipadas.md) | Usar chaves primárias tipadas com `PrimaryKey` | Accepted |
